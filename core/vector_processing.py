...
def create_point_feature(x, y, template_properties=None):
    props = template_properties.copy() if template_properties else {
        'id': 0, 'name': '', 'layer': 'POINT', 'length': 0.0, 'area': 0.0, 'remark': ''
    }
    return {
        'type': 'Feature',
...
def create_line_feature(points, template_properties=None):
    ...
    props = template_properties.copy() if template_properties else {
        'id': 0, 'name': '', 'layer': 'LINE', 'length': round(length_val,2), 'area': 0.0, 'remark': ''
    }
    return {
        'type': 'Feature',
...
def create_polygon_feature(points, template_properties=None):
    ...
    props = template_properties.copy() if template_properties else {
        'id': 0, 'name': '', 'layer': 'POLYGON', 'length': length_val, 'area': area_val, 'remark': ''
    }
    return {
        'type': 'Feature',
